...
export function PortfolioNavbar() {
  ...
  return (
    <>
      <motion.nav
        className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-50 p-2 rounded-2xl border border-border/50 shadow-2xl relative overflow-hidden transition-all duration-300 ${
          isScrolled
